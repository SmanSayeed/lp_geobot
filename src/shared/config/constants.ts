...
export const logoName = "/img/logo/logo.png";
export const brands = {
  brand1: "/img/logo/brand-1.png",
  brand2: "/img/logo/brand-2.png",
  brand3: "/img/logo/brand-3.png",
...
export const cross_icon = "/img/icons/cross.png"
export const check_circle = "/img/icons/check-circle.png"
